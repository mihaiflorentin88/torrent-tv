...
mv "$stage"/*.wgt "$root/.build/artifacts/torrent-tv-$version-samsung-tizen-signed.wgt"
sha256sum "$root/.build/artifacts/torrent-tv-$version-samsung-tizen-signed.wgt" > "$root/.build/artifacts/torrent-tv-$version-samsung-tizen-signed.wgt.sha256"
